          ...
          <form action="" class="order-view__form" @submit="onSubmit">
            <div v-if="step === 1" class="order-view__step">
              ...
              <div class="order-view__row || row">
                <div class="column -size-6">
                  <div class="order-view__field">
                    <label class="order-view__label" for="firstname"
                      >Prénom</label
                    >
                    <input
                      class="order-view__input"
                      id="firstname"
                      type="text"
              ...
              <div class="order-view__row || row">
                <div class="column -size-6">
                  <div class="order-view__field">
                    <label class="order-view__label" for="address_1"
                      >Adresse</label
                    >
                    <input
                      class="order-view__input"
                ...
                <div class="column -size-6">
                  <div class="order-view__field">
                    <label class="order-view__label" for="address_2"
              ...
              <div class="order-view__row || row">
                ...
                <div class="column -size-6">
                  <div class="order-view__field">
                    <label class="order-view__label" for="state"
                      >État/Région</label
                    >
                    <input
                      class="order-view__input"
              ...
              <div class="order-view__row || row">
                <div class="column -size-6">
                  <div class="order-view__field">
                    <label class="order-view__label" for="postcode"
                      >Code postal</label
                    >
                    <input
                      class="order-view__input"
              ...
              <div class="order-view__row || row">
                <div class="column -size-6">
                  <div class="order-view__field">
                    ...
                    />
                    <span v-if="!validation.email" class="order-view__error"
                ...
                <div class="column -size-6">
                  <div class="order-view__field">
                    <label class="order-view__label" for="phone"
                      >Téléphone</label
                    >
                    <input
                      class="order-view__input"
              ...
              <div class="order-view__shipping" v-if="otherAddress">
                ...
                <div class="order-view__row || row">
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-firstname"
                        >Prénom</label
                      >
                      <input
                        class="order-view__input"
                  ...
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-lastname"
                        >Nom</label
                      >
                      <input
                        class="order-view__input"
                ...
                <div class="order-view__row || row">
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-address_1"
                        >Adresse</label
                      >
                      <input
                        class="order-view__input"
                  ...
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-address_2"
                        >Complément d'adresse</label
                      >
                      <input
                        class="order-view__input"
                ...
                <div class="order-view__row || row">
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-city"
                        >Ville</label
                      >
                      <input
                        class="order-view__input"
                  ...
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-state"
                        >État/Région</label
                      >
                      <input
                        class="order-view__input"
                ...
                <div class="order-view__row || row">
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-postcode"
                        >Code postal</label
                      >
                      <input
                        class="order-view__input"
                  ...
                  <div class="column -size-6">
                    <div class="order-view__field">
                      <label class="order-view__label" for="shipping-country"
                        >Pays</label
                      >
                      <select
                        id="country"
              ...
              <!--  -->
              <ButtonHM @click="changeStep(2)">Étape suivante</ButtonHM>
            </div>
            <div v-if="step === 2" class="order-view__step">
              ...
              <div class="order-view__row || row">
                <div class="column -size-12">
                  <div class="order-view__field">
                    <label class="order-view__label" for="card-number"
                    ...
                    />
                    <span v-if="!validation.number" class="order-view__error"
              ...
              <div class="order-view__row || row">
                <div class="column -size-6">
                  <div class="order-view__field">
                    ...
                    <input
                      ...
                      v-model="payment.cvv"
                    />
                    <span v-if="!validation.cvv" class="order-view__error"
                ...
                <div class="column -size-6">
                  <div class="order-view__field">
                    <label class="order-view__label" for="expiration"
              ...
              <div v-else class="order-view__buttons">
                <ButtonHM @click="step--">Retour</ButtonHM>
                <ButtonHM @click="confirmInformation"
                  >Valider ma commande</ButtonHM
                >
              </div>
              <p
                v-if="feedback.message"
                :class="['order-view__feedback', `-is-type-${feedback.type}`]"
              >
                {{ feedback.message }}
              </p>
            </div>
...
export default {
  components: { Loader, CartProduct, ButtonHM },
  data() {
    return {
      otherAddress: false,
      loading: false,
